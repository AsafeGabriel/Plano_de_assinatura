...
function HomeScreen({ navigation, route }) {
  ...
  return (
    <ScrollView style={styles.page} contentContainerStyle={styles.content}>
      ...
      {isLoggedIn && profData && profData.length > 0 && (
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Área Profissional</Text>
          <Pressable style={styles.primaryButton} onPress={() => navigation.navigate('Professional', { professional: profData[0]?.name || 'Profissional', clients: profData[0]?.clients || [], balance: profData[0]?.balance || 0 })}>
